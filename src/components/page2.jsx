...
function Page2() {
    ...
    return(
        ...
        <svg className='svg-car' viewBox="0 0 178 40" width="178" height="40">
    ...
    <g
       ...
       <br></br>
       <div className='car-page2'>
              <h3>I love cars and enjoy watching car racing in Formula1! &nbsp; </h3>
              <br></br>
              <span><button style={{fontWeight:'bold',paddingRight:50,paddingLeft:40, backgroundColor:"#960019", border:"none"}} 
                     className='btn btn-primary btn-lg m-3' onClick={()=>{navigate("/Page3")}} >&nbsp;&nbsp; Next &nbsp;&nbsp;</button>
              </span>
        </div>
        </header>
        </div>
